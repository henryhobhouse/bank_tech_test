describe StatementPrinter do
  ...
  let(:creditStatement) { described_class.print_statement(credithistory) { include StatementPrinter } }
  let(:debitStatement) { described_class.print_statement(debithistory) { include StatementPrinter } }
